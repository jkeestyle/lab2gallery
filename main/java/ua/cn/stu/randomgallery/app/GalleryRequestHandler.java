...
/**
 * Custom request handler for loading images via Picasso.
 * Custom handler is used because Picasso can't load images
 * provided by {@link SimpleGalleryStorage}.
 *
 * URI template: "gallery://{localPhotoId}"
 */
